...
# Date: 9/10/2026
print("=============================================================")
print("            ^^Gilmore Girls Character Profile^^              ")
print("=============================================================")
print()
print("------------------^^Charatcter Info^^------------------------")
print()
print("Name: Lorelai Gilmore")
print("Age: 32")
print("Occupation: Hotel Manager")
print()
print("------------^^Character Additional Attributes^^--------------")
print()
...
print()                                                                                                     
print('" Everything in my life has something to do with coffee. I believe in a former life I was coffe."')
print("~ Lorelai Gilmore")